...
**Catatan perhitungan nilai:**
- Rumus: `nilai = round((benar / total_soal) * 100, 2)`
- Nilai dikembalikan sebagai angka (contoh: `96.67`)
...
**Catatan:**
- Field `nilai` menggunakan pembulatan 2 desimal (`round(..., 2)`).
